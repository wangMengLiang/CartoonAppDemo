...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize * GlobalScale];
		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize * GlobalScale];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
